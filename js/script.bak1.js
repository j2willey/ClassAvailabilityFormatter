document.addEventListener('DOMContentLoaded', function() {
    ...
    let netOpen   = '';
    let dateStamp = '';
    classNum  : { reportSignature : ['Class #'], repColNum : '', displayCol : '' },
    className : { reportSignature : ['Class Name'], repColNum : '', displayCol : '' },
    block     : { reportSignature : ['Period'], repColNum : '', displayCol : '' },
    location  : { reportSignature : ['Room'], repColNum : '', displayCol : '' },
    maxSeats  : { reportSignature : ['Max', 'Class', 'Size'], repColNum : '', displayCol : '' },
    seatsTaken : { reportSignature : ['Nbr', 'Seats', 'Taken'], repColNum : '', displayCol : '' },
    seatsOpen : { reportSignature : ['Nbr', 'Seats', 'Open'], repColNum : '', displayCol : '' },
    waitlisted : { reportSignature : ['Wait', 'List', 'Count'], repColNum : '', displayCol : '' },
    ...
    functio: { reportSignature : colName), repColNum : '', displayCol : '' },
